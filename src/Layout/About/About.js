...
const About = () => {
  return (
    <div className="Contaner">
      <div
        className="row StyleRow"
        style={{ height: "500px", margin: "12px auto" }}
      >
        <h1
        ...
        />
        <div className="StyleText" style={{textAlign: "justify" }}>
          <p className="font-iransans">
            ...
            صفحه‌آرایی می‌کنند تا مرحله طراحی و صفحه‌بندی را به پایان ببرند.
          </p>
        </div>
      </div>
    </div>
